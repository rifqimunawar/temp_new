...
@section('content-module')
  ...
  <div class="row card rounded">
    ...
    <script type="text/template" id="customAddButtonTemplate">
      <a href="{{ route('menu.create') }}" class="btn btn-sm btn-primary mr-3"> <i class="fa fa-plus" style="font-size: 14px; color: white;"></i> Tambah</a>
    </script>
      ...
      <tbody>
        @foreach ($data as $item)
          <tr>
            ...
            <td>{{ $item->url ?? '-' }}</td>
            <td>
              <a href="{{ route('menu.edit', $item->id) }}" style="text-decoration: none;">
                <i class="fa fa-pencil-square" style="font-size: 16px; margin-right:5px; color: blue;"></i>
              </a>
              <a href="{{ route('menu.destroy', $item->id) }}" data-confirm-delete="true" style="text-decoration: none;">
