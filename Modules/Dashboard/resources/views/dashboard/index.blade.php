          ...
          <div class="card-body position-relative text-white text-opacity-70">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="mt-3 mb-2">
                  <a href="#" class="btn btn-yellow btn-rounded btn-sm ps-5 pe-5 pt-2 pb-2 fs-14px fw-600"><i
          ...
          <div class="col-sm-6">
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange" style="min-height: 199px;">
              ...
              <div class="card-body position-relative">
                ...
                <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 16% increase <br>compare
                  to last week</div>
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 199px;">
              ...
              <div class="card-body position-relative">
                ...
                <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 33% increase <br>compare
                  to last week</div>
                <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View report
                    <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
              </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
              ...
              <div class="card-body position-relative">
                ...
                <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 20% increase <br>compare
                  to last week</div>
                <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View report
                    <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
              </div>
              ...
              <table class="table table-borderless mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><span class="badge text-body text-opacity-50 bg-dark bg-opacity-10"
